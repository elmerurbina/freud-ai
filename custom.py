...
def chatbot_response(user_input):
    ...
    # If no predefined response, check Rasa responses
    if user_input.lower() in combined_data.get('responses', {}):
        return random.choice(combined_data['responses'][user_input.lower()])

    # If not found in Rasa responses, use the existing logic
