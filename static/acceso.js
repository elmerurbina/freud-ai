...
document.addEventListener('DOMContentLoaded', function() {
    ...
    accessTermsLink.addEventListener('click', function(event) {
        ...
        termsWindow.document.write('<style>body { font-family: Arial, sans-serif; }</style>');
        ...
        termsWindow.document.write('<p>4. Consentimiento Informado: El psicólogo reconoce que el acceso a los registros del usuario requiere el consentimiento informado del paciente o su representante legal, según corresponda. Se debe obtener un consentimiento explícito antes de acceder a los registros del usuario.</p>');
        termsWindow.document.write('<p>Al hacer clic en el enlace "Términos de Acceso", usted acepta cumplir con estos términos y condiciones para acceder a los registros del usuario.</p>');
    });
});
